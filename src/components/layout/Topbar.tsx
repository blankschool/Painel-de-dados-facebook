      ...
      <div className="flex items-center gap-2 md:gap-3 flex-wrap">
        ...
        <Popover open={isCalendarOpen} onOpenChange={setIsCalendarOpen}>
          <PopoverTrigger asChild>
            <button type="button" className="date-range hover:bg-accent/50 transition-colors rounded-lg px-2 py-1.5 md:px-4 md:py-2 text-xs md:text-sm">
              <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" className="w-4 h-4 md:w-[18px] md:h-[18px]">
                <rect x="3" y="4" width="18" height="18" rx="2" />
                <line x1="16" y1="2" x2="16" y2="6" />
                <line x1="8" y1="2" x2="8" y2="6" />
                <line x1="3" y1="10" x2="21" y2="10" />
              </svg>
              <span id="dateRangeText" className="hidden xs:inline">{dateLabel}</span>
              <ChevronDown className="h-3 w-3 md:h-3.5 md:w-3.5 text-muted-foreground" />
            </button>
          </PopoverTrigger>
